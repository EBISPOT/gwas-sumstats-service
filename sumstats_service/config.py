...
MAIL_FROM = _env_variable_else("MAIL_FROM", "gwas-dev@ebi.ac.uk")
MAIL_TO = _env_variable_else("MAIL_TO", "gwas-dev@ebi.ac.uk")
...
VALIDATION_ERRORS = [
    ...
    {
        "id": 9,
        "errorText": "Summary statistics file validation failed: File contains fewer than 100,000 rows. If you have fewer than 100,000 variants in your dataset, please contact gwas-subs@ebi.ac.uk for further advice.",
    },
    {
        "id": 10,
